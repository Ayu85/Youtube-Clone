...
const VideoCard = ({ snippet, statistics, contentDetails }) => {
    ...
    return (
        <div className={`relative w-[375px] h-[330px] py-1    ${!theme && "shadow-lg shadow-slate-200"} ${theme && "text-slate-50 shadow-[#2c2c2c9d] shadow-lg  "}`}>
            ...
            <h1 className={`w-[330px] h-14 overflow-hidden font-semibold text-lg  ml-3 mt-[215px] ${!theme && "text-slate-700"} ${theme && "text-slate-300"}`}>{snippet.title}</h1>
